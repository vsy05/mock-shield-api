#!/bin/bash
################################################################################
# Filename        : shield_identifiedrisk_get_mocktest.bash
...
PAGE_LIMIT=2
OUTPUT_DIR="./output"
OUTPUT_FILE_PREFIX="SHIELD_IDENTIFIEDRISK_LIST_ALL"
...
GCS_PATH_PREFIX="identifiedrisk_list_all/landing/"

LOG_DIR="${SYS_LOG:-.}"
LOG_FILE="${LOG_DIR}/shield_identifiedrisk_get_mocktest_$(date -u '+%Y%m%d_%H%M%S').log"
...
################################################################################
main() {
    log "=== MOCK TEST: InfoExchange (Shield) riskAssessments/identifiedRisk ==="

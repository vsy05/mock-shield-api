#!/bin/bash
################################################################################
# Filename        : shield_injuredperson_get_mocktest.bash
...
TABLE_ID="injuredPerson"

PAGE_LIMIT=2
OUTPUT_DIR="./output"
OUTPUT_FILE_PREFIX="SHIELD_INJUREDPERSON_LIST_ALL"
...
GCS_PATH_PREFIX="injuredperson_list_all/landing/"

LOG_DIR="${SYS_LOG:-.}"
LOG_FILE="${LOG_DIR}/shield_injuredperson_get_mocktest_$(date -u '+%Y%m%d_%H%M%S').log"
...
################################################################################
main() {
    log "=== MOCK TEST: InfoExchange (Shield) incidentReporting/injuredPerson ==="
